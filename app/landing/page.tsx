...
import LandingContactForm from '../../src/components/landing/LandingContactForm';
import { Shield, Award, MapPin, Wrench, PhoneCall } from 'lucide-react';
  ...
  return (
    <>
      ...
      <main className="bg-dark">
        ...
        <section className="bg-dark/80 py-12 border-y border-white/5 backdrop-blur-md">
          <div className="mx-auto max-w-7xl px-6 flex flex-col md:flex-row justify-between items-center gap-8">
            ...
            <a
              ...
              className="animated-button group !rounded-2xl !py-6 !px-10 flex w-full md:w-auto"
            >
              <span className="anim-text flex items-center justify-center gap-3 text-xl font-black uppercase tracking-widest">
                <PhoneCall className="h-6 w-6" /> {BUSINESS.phone}
              </span>
        ...
        <div id="appointment-form" className="bg-white py-24 border-b border-gray-100">
