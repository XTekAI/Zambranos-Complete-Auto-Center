        ...
        <div className="grid items-center gap-16 lg:grid-cols-2">
          ...
          >
            ...
            <p className="mt-4 text-lg leading-relaxed text-muted">
              Conveniently located on Hamilton Ave. Drop by or call to schedule your service today.
            </p>
            ...
            <div className="mt-8 space-y-4">
              <div className="flex gap-4 rounded-xl bg-surface p-4">
                ...
                <div>
                  <h3 className="font-display font-bold text-dark">Location</h3>
                  <p className="text-sm text-muted">{BUSINESS.address}</p>
                  <a
                    href={LINKS.google}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="mt-1 inline-block text-xs font-bold text-primary transition-colors hover:text-dark cursor-pointer"
                  >
                    Get Directions
                  </a>
                </div>
              ...
              <div className="flex gap-4 rounded-xl bg-surface p-4">
                ...
                <div>
                  <h3 className="font-display font-bold text-dark">Phone</h3>
                  <a
                    href={BUSINESS.phoneTel}
                    className="text-lg font-bold text-dark transition-colors hover:text-primary cursor-pointer"
                  >
                    {BUSINESS.phone}
                  </a>
                </div>
              ...
              <div className="flex gap-4 rounded-xl bg-surface p-4">
                ...
                <div className="w-full">
                  <div className="flex items-center justify-between">
                    <h3 className="font-display font-bold text-dark">Hours</h3>
                    <BusinessStatus />
                  </div>
                  <ul className="mt-2 space-y-1 text-sm text-muted">
                    {HOURS.map((h) => (
                      <li key={h.day} className={`flex justify-between ${h.time === 'Closed' ? 'text-primary' : ''}`}>
                        ...
                        <span className={h.time === 'Closed' ? 'font-bold' : 'font-medium text-dark'}>{h.time}</span>
                      </li>
                    ))}
                  </ul>
                </div>
          ...
          <motion.div
            ...
            className="relative h-[550px] overflow-hidden rounded-2xl shadow-lg"
          >
            <iframe
