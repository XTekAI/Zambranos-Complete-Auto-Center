...
const services = [
  ...
  },
  {
    ...
    icon: <Move className="w-8 h-8 text-red-600" />,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h2 className="text-4xl md:text-5xl font-extrabold text-zinc-950 mb-6 tracking-tight">
            High-Performance <span className="text-red-600">Auto Care</span>
          </h2>
          ...
          {services.map((service, index) => (
            ...
            >
              ...
              <div className="p-6 flex-grow flex flex-col">
                ...
                <a
                  href={service.link}
                  className="inline-flex items-center gap-2 text-red-600 font-bold hover:text-red-700 transition-colors group/link"
                >
                  Learn More
