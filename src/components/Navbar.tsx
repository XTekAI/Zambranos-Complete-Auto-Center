...
export default function Navbar() {
  ...
  return (
    <nav className="bg-zinc-950 text-white sticky top-0 z-50 border-b border-zinc-800">
      {/* Top Bar */}
      <div className="bg-primary text-white py-2 px-4 text-sm font-medium text-center hidden md:block">
        ...
        <div className="flex justify-between items-center h-20">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <div className="flex flex-col items-end">
              <a href="tel:609-396-8417" className="flex items-center gap-2 text-xl font-bold text-white hover:text-primary transition-colors">
          ...
          <div className="md:hidden flex items-center">
            <a href="tel:609-396-8417" className="mr-4 text-white p-2 bg-primary rounded-full">
      ...
      {isOpen && (
        <div className="md:hidden bg-zinc-900 border-t border-zinc-800">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            ...
            <a href="tel:609-396-8417" className="block px-3 py-2 text-base font-medium text-primary hover:bg-zinc-800 rounded-md">Call (609) 396-8417</a>
